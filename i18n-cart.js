...
(function(){
  ...
  const dict = {
    en: {
      ...
      'landing.curated.title': 'Elegance. Confidence. Osun.',
      'landing.curated.subtitle': 'Inspired by grace and softness, explore signatures that pair polished tailoring with natural glow.',
      'landing.curated.cta': 'Browse all categories',
      'landing.curated.dresses': 'Statement dresses',
      'landing.curated.tops': 'Polished tops',
      'landing.curated.beauty': 'Glow rituals',
      ...
      'catpage.quick.tag': 'Spotlight',
      'catpage.quick.title': 'Shop the highlights',
      'catpage.quick.subtitle': 'A boutique snapshot of our most-loved categories for effortless browsing.',
      'catpage.quick.dresses': 'Romantic dresses',
      'catpage.quick.tops': 'Polished tops',
      'catpage.quick.beauty': 'Glow rituals',
      'catpage.quick.accessories': 'Finishing touches',
      ...
      'aboutpage.legacy.title': 'About Osun Beauty & Boutique',
      'aboutpage.legacy.desc': 'Osun was born from a commitment to elegance and confidence. Each curation carries a gentle, effortless style that lets every woman shine in daily life.',
      ...
      'admin.quick.heading': 'Quick content update',
      'admin.quick.desc': 'Use this lightweight form to jot down a new product highlight and log incoming imagery before sharing with the developer.',
      'admin.quick.titleLabel': 'Product or collection name',
      'admin.quick.imageLabel': 'Upload inspiration image',
      'admin.quick.submit': 'Log update',
    ...
    zh: {
      ...
      'hero.cta1': '立即選購',
      'hero.cta2': '探索美妝',
      'landing.curated.title': '優雅．自信．OSUN',
      'landing.curated.subtitle': '以優雅與自信為靈感，呈現自然柔滑的時尚風格。',
      'landing.curated.cta': '查看全部',
      'landing.curated.dresses': '洋裝',
      'landing.curated.tops': '上衣',
      'landing.curated.beauty': '保養儀式',
      'cat.title': '依分類選購',
      'cat.viewall': '查看全部',
      'cat.dresses': '洋裝',
      'cat.tops': '上衣與襯衫',
      ...
      'catpage.quick.tag': '焦點',
      'catpage.quick.title': '精選分類快速逛',
      'catpage.quick.subtitle': '快速掌握最受歡迎的分類，輕鬆找到靈感。',
      'catpage.quick.dresses': '浪漫洋裝',
      'catpage.quick.tops': '質感上衣',
      'catpage.quick.beauty': '光采儀式',
      'catpage.quick.accessories': '點綴飾品',
      ...
      'aboutpage.legacy.title': '關於 Osun Beauty & Boutique',
      'aboutpage.legacy.desc': 'Osun 的誕生源於老闆娘對「優雅與自信」的堅持。每件商品都代表自然柔滑的風格，陪伴女性在日常中綻放光彩。',
      ...
      'admin.quick.heading': '快速內容紀錄',
      'admin.quick.desc': '透過精簡表單，先行記錄商品亮點與圖片素材，方便稍後交接給工程師。',
      'admin.quick.titleLabel': '商品或系列名稱',
      'admin.quick.imageLabel': '上傳靈感圖片',
      'admin.quick.submit': '紀錄更新',
